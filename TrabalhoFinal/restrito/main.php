        ...
        <div class="col-md-4">
          <div class="card dashboard-option">
            <div class="card-body text-center">
              ...
              <a href="listagem_funcionarios.php" class="btn btn-primary">Visualizar</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card dashboard-option">
            <div class="card-body text-center">
              ...
              <a href="listagem_medicos.php" class="btn btn-primary">Visualizar</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card dashboard-option">
            <div class="card-body text-center">
              ...
              <a href="listagem_agendamentos.php" class="btn btn-primary">Visualizar</a>
            </div>
          </div>
        </div>
